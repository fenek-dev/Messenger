...
describe('<AuthForm>',()=> {
    ...
    it('should work correctly in login type', async() => {
        ...
        render(<MemoryRouter initialEntries={['/companionid']} > <Route path='/:id'><AuthForm type='login' signIn={signIn} /></Route></MemoryRouter>)
        ...
        expect(initialState.user).toEqual({name:'Maks', email:'correct@test.com', password:'correctpassword'})
    ...
    it('should work correctly in register type', async() => {
        ...
        render(<MemoryRouter initialEntries={['/companionid']} > <Route path='/:id'><AuthForm type='register' createUser={createUser} /></Route></MemoryRouter>)
